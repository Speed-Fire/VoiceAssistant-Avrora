...
redis_timestamps_recognition_set_name = os.getenv("REDIS_HASHES_RECOGNITION_TIMESTAMPS")
...
redis_timestamps_command_handling_set_name = os.getenv("REDIS_HASHES_COMMAND_HANDLING_TIMESTAMPS")
