...
redis_timestamps_recognition_queue_name = os.getenv("REDIS_QUEUES_RECOGNITION_TIMESTAMPS")
...
redis_timestamps_command_handling_queue_name = os.getenv("REDIS_QUEUES_COMMAND_HANDLING_TIMESTAMPS")
